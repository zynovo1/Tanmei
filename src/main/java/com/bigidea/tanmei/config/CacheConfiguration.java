package com.bigidea.tanmei.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("Tanmei");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("Tanmei");
        ...
        config.getMapConfigs().put("com.bigidea.tanmei.domain.*", initializeDomainMapConfig(jHipsterProperties));
